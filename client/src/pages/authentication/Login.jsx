    ...
    return (
        <>
            <div className='flex flex-col items-center justify-center font-roboto'>
                ...
                <form onSubmit={handleLogin} className='flex p-6 flex-col gap-6 items-center justify-center'>
                    ...
                    <button type='submit' className='border border-blue-400 mt-5 cursor-pointer rounded-md p-2 bg-blue-500/80 w-full hover:bg-blue-500'>Login</button>

                    <div className='h-0.5 bg-gray-800 w-full'></div>

                    <div>
                        <p className='text-gray-400'>Don't have an account?<button type='button' onClick={()=> setTabActive("register")} className='text-blue-500 cursor-pointer'>Register</button></p>
                    </div>
                </form>
            </div>
        </>
