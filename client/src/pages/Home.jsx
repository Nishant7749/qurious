            ...
            <div className='flex flex-col'>
                <div className='flex'>
                    ...
                    <div className='flex gap-4 ml-8'>
                        <button className='bg-[#6366F1] p-3 w-40 rounded-xl cursor-pointer shadow-md shadow-black hover:bg-[#0F172A] hover:border hover:border-[#6366F1]'>Create Quiz</button>
                        <button className='border border-[#6366F1] w-40 p-3 rounded-xl shadow-md shadow-black hover:bg-[#6366F1] cursor-pointer'>Take a Quiz</button>
                    </div>
                    </div>
